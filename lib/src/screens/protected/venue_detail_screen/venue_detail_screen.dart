          ...
          child: Column(
            ...
            children: [
              ClipRRect(
                ...
                child: Image.asset(
                  'lib/assets/images/dummy_event.png',
                  height: 180,
              ...
              const Text(
                'Lorem ipsum dolor sit amet consectetur. Augue massa fermentum scelerisque dolor in aliquet.',
              ...
              Row(
                children: const [
                  ...
                  SizedBox(width: 8),
                  Text('Opening hour', style: TextStyle(color: Color(0xFFD1B26F), fontWeight: FontWeight.bold)),
                ],
              ),
              const SizedBox(height: 4),
              Row(
                children: const [
                  ...
                  SizedBox(width: 16),
                  Text('19:00 PM - 01:00 AM', style: TextStyle(color: Colors.white70)),
                ],
              ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Text('Dance', style: TextStyle(color: Colors.white, fontSize: 12)),
                      ),
                      const Spacer(),
                      DecoratedBox(
                        decoration: BoxDecoration(
                        ...
                        child: Padding(
                          ...
                          child: Icon(Icons.favorite_border, color: Color(0xFFFFE7B9)),
                        )),
                    ],
                  ),
                ),
